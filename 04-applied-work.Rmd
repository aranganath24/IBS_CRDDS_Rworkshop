...
WB_filenames_export<-paste0(worldbank_filenames_base, "_cleaned.csv")
```

```{r, echo=-1}
setwd("exported_objects")
# exports datasets in "world_bank_list_cleaned" to working directory using filenames in "WB_filenames_export"
